...
function addMessage(){ //отправляет сообщение
...
function updateLastMessage(){ //обновляем информацию о последнем сообщении, отправленном в беседе или диалоге если существует
...
function addMember(){ //добавляет выбранного друга в беседу
    $member = $_POST['member'];
